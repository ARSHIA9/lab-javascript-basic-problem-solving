...
// 1.1 Create a variable `ProGrad-1` with the driver's name.
    var ProGrad_1 = "Arshia";
// 1.2 Print `"The driver's name is XXXX"`.
    console.log(ProGrad_1)
// 1.3 Create a variable `ProGrad-2` with the navigator's name.
    var ProGrad_2 = "Subham";
...
if (ProGrad_1.length > ProGrad_2.length) {
    ...
    console.log(
      "Wow, you both have equally long names, " + ProGrad_2.length + " characters."
    );
  }
...
var output = "";
var capitals = ProGrad_1.toUpperCase();
...
var a = ProGrad_1.localeCompare(ProGrad_2);
if (a < 0) {
...
console.log("Number of times the latin word et appears is " + str.match(/ e/g).length);
// Bonus 2:
